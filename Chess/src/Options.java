...
public class Options extends JFrame implements Runnable, java.io.Serializable {
 /**
	...
	public Options(Gamewindow gw, Game g) {
	    ...
	    JRadioButton[] aiButtons = new JRadioButton[5];
	    ...
	    aiButtons[3] = new JRadioButton("Computer vs Computer Easy");
	    aiButtons[3].setBounds(0, 170, 220, 20);
	    this.add(aiButtons[3]);
	    aiButtons[4] = new JRadioButton("Computer vs Computer Hard");
	    aiButtons[4].setBounds(0, 190, 220, 20);
	    this.add(aiButtons[4]);
	    ...
	    aiPlayer.setBounds(10, 210, 30, 30);
	    ...
	    label4.setBounds(45, 218, 400, 10);
	  this.add(label);
	  this.add(label2);
	  this.add(label3);
	  this.add(label4);
