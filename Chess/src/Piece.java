...
public abstract class Piece implements java.io.Serializable{
 ...
 public Piece(int id, Color color, Position pos, ImageIcon image) {
	 this.id = id;
	 if (!(this instanceof King) && !(this instanceof Pawn))
...
public int getKingDirection() {
	return this.kingDirection;
}
public void setKingDirection(int val) {
	this.kingDirection = val;
}
